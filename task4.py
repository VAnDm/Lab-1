...
# функция рисует горизонтальную столбчатую диаграмму массива чисел (массив произвольного размера), maxlen - длина полосы соответствующей самому большому числу в массиве (по умолчанию 100), числа отображаются в виде десятичной дроби с не более чем 3 знаками после запятой
